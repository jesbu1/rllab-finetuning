...
import sys
log_dir = sys.argv[1]
COMMAND = "OMP_NUM_THREADS=8 python3 sandbox/finetuning/runs/pg_test.py --algo hippo_random_p -trainsnn -random_init -d 0.98 -tpi 30 -p 7 -eps 0.1 -minp 3 -latdim 9 -mb -sbl -msb -lr 3e-4 --logdir " + log_dir
...
envs = ["FetchSlide-v1", ]#"FetchPush-v1", "FetchSlide-v1", "FetchPickAndPlace-v1"]

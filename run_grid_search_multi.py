...
import sys
log_dir = sys.argv[1]
COMMAND = "OMP_NUM_THREADS=2 python3 sandbox/finetuning/runs/pg_test.py --env_name GoalTask --algo hippo_random_p -trainsnn -random_init -d 0.99 -mb -sbl -msb -lr 3e-4 --logdir " + log_dir
